...
class Water:
    def __init__(self):
        ...
        self.icon = pygame.transform.scale(
            pygame.image.load("assets/watericon.png"), (32, 32))
        self.water_for_tutorial = pygame.transform.scale(
            pygame.image.load('assets/watericon.png'), (125, 125))
        ...
        if self.tutorial:
            self.textbox.render(
                ...
                (255,
                 255,
                 255),
                "This is ice, click on it to get water!\nwater can be used for upgrades\nand smelting ore!",
                (120,
                 65),
                (255,
                 255,
                 255),
                self.water_for_tutorial,
                150)
            self.tutorial = False
