...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image_right = [
            pygame.image.load("assets/right1.png"),
            pygame.image.load("assets/right2.png"),
            pygame.image.load("assets/right1.png"),
            pygame.image.load("assets/right3.png")]  # loading the player in
        self.image_left = [
            pygame.image.load("assets/left1.png"),
            pygame.image.load("assets/left2.png"),
            pygame.image.load("assets/left1.png"),
            pygame.image.load("assets/left3.png")]
    ...
    def move(self):  # method to do the running\
        ...
        if pressed_keys[K_LEFT] or pressed_keys[K_a]:
            # making it so when you press the left arrow key the acc goes down
            self.acc.x += -self.ACC
