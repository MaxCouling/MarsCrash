...
class Game:
    def __init__(self):
        ...
        # all the things in my game that can be clicked
        self.click_list = [self.mine, self.water, self.crash]
        ...
        self.power_level = pygame.Rect(
            X_POWER + 40, Y_POWER + 12, self.power_amount, 25)
    ...
    def game(self):
        ...
        while True:  # main loop
            ...
            # adding 5 to make th power symbol to go downa little on the screen
            # as it was a bit too high before on the screen
            self.window.blit(self.power_icon, (X_POWER, Y_POWER + 5))
    ...
    def gravity_check(self):
        """If the player y velocity is more than 0, it plays this function"""
        hits = pygame.sprite.spritecollide(
            self.player, self.groundgroup, False)
        if self.player.vel.y > 0:
            if hits:
                ...
                if self.player.pos.y < lowest.rect.bottom:  # if the player is touching the ground
                    ...
                    # if player is touching the ground, it cannot be in the
                    # state of jump (duh)
    ...
    def jump(self):
        ...
        # If touching the ground, and not currently jumping, cause the player
        # to jump.
    ...
    def mouse_is_over(self, obj):
        ...
        # basically saying if the mouse is within the object, return true
    ...
    def terminal(self):
        ...
        while running:
            ...
            # gets the mouse postion. mx is mouse x and mouse y is mouse y
            ...
            if self.exitbutton.collidepoint(
                    (mx, my)):  # if the player's mouse is over the exit button
